...
import type { AppConfig, ChatMessage as ChatMessageType } from "@/lib/config";
...
export function ChatApp({ config }: { config: AppConfig }) {
  ...
  const handleSend = useCallback(async (content: string) => {
    ...
    try {
      const stream = streamChat(config.apiUrl, conversation, controller.signal);
      let accumulated = "";
